 ...
 */
/**
 * Stripe publishable key (pk_test_… / pk_live_…). Used for shop embedded checkout if the
 * createShopCheckoutPayment callable does not return publishableKey (set STRIPE_PUBLISHABLE_KEY on Functions).
 */
